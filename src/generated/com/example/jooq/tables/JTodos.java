...
public class JTodos extends TableImpl<TodosRecord> {
    ...
    private JTodos(Name alias, Table<TodosRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private JTodos(Name alias, Table<TodosRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> JTodos(Table<O> path, ForeignKey<O, TodosRecord> childPath, InverseForeignKey<O, TodosRecord> parentPath) {
     ...
     */
    public static class TodosPath extends JTodos implements Path<TodosRecord> {
