...
public class JTokens extends TableImpl<TokensRecord> {
    ...
    private JTokens(Name alias, Table<TokensRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private JTokens(Name alias, Table<TokensRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> JTokens(Table<O> path, ForeignKey<O, TokensRecord> childPath, InverseForeignKey<O, TokensRecord> parentPath) {
     ...
     */
    public static class TokensPath extends JTokens implements Path<TokensRecord> {
